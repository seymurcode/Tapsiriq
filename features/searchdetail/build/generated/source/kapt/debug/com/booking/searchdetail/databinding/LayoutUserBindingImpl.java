...
public class LayoutUserBindingImpl extends LayoutUserBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.txtSurname, 2);
        sViewsWithIds.put(R.id.txtPhone, 3);
    }
    // views
    @NonNull
    ...
    public LayoutUserBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
    ...
    protected void executeBindings() {
        ...
        if ((dirtyFlags & 0x3L) != 0) {
            ...
            androidx.databinding.adapters.TextViewBindingAdapter.setText(this.txtName, adi);
        }
    }
