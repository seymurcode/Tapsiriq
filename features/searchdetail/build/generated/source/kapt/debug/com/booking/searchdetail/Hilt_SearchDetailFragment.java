 ...
 */
public abstract class Hilt_SearchDetailFragment<B extends ViewBinding> extends BaseFragment<B> implements GeneratedComponentManagerHolder {
  ...
  Hilt_SearchDetailFragment(
      Function3<? super LayoutInflater, ? super ViewGroup, ? super Boolean, ? extends B> inflate) {
    super(inflate);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((SearchDetailFragment_GeneratedInjector) this.generatedComponent()).injectSearchDetailFragment(UnsafeCasts.<SearchDetailFragment>unsafeCast(this));
    }
  }
