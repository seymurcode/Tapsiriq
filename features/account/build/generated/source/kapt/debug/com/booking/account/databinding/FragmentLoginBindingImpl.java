...
public class FragmentLoginBindingImpl extends FragmentLoginBinding implements com.booking.account.generated.callback.OnClickListener.Listener {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.subtitleTextView, 6);
        sViewsWithIds.put(R.id.forgotPasswordTextView, 7);
        sViewsWithIds.put(R.id.socialLoginLayout, 8);
        sViewsWithIds.put(R.id.login_button_facebook, 9);
        sViewsWithIds.put(R.id.login_button_google, 10);
    }
    // views
    @NonNull
    ...
    private androidx.databinding.InverseBindingListener passwordEditTextandroidTextAttrChanged = new androidx.databinding.InverseBindingListener() {
        ...
        public void onChange() {
            ...
            // viewModel
            com.booking.account.login.LoginViewModel viewModel = mViewModel;
            // viewModel.password
    ...
    private FragmentLoginBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        ...
        setRootTag(root);
        // listeners
        mCallback1 = new com.booking.account.generated.callback.OnClickListener(this, 1);
        mCallback2 = new com.booking.account.generated.callback.OnClickListener(this, 2);
        invalidateAll();
    }
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.viewModel == variableId) {
            setViewModel((com.booking.account.login.LoginViewModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setViewModel(@Nullable com.booking.account.login.LoginViewModel ViewModel) {
    ...
    protected void executeBindings() {
        ...
        if ((dirtyFlags & 0x8L) != 0) {
            ...
            this.registerButton.setOnClickListener(mCallback2);
        ...
        if ((dirtyFlags & 0xeL) != 0) {
            ...
            androidx.databinding.adapters.TextViewBindingAdapter.setText(this.passwordEditText, viewModelPasswordGetValue);
        }
        if ((dirtyFlags & 0xdL) != 0) {
            // api target 1

            androidx.databinding.adapters.TextViewBindingAdapter.setText(this.usernameEditText, viewModelEmailGetValue);
        }
    }
