 ...
 */
public abstract class Hilt_SearchListFragment<B extends ViewBinding> extends BaseFragment<B> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((SearchListFragment_GeneratedInjector) this.generatedComponent()).injectSearchListFragment(UnsafeCasts.<SearchListFragment>unsafeCast(this));
    }
  }
