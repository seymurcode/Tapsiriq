 ...
 */
public abstract class Hilt_HotelListFragment<B extends ViewBinding> extends BaseFragment<B> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((HotelListFragment_GeneratedInjector) this.generatedComponent()).injectHotelListFragment(UnsafeCasts.<HotelListFragment>unsafeCast(this));
    }
  }
